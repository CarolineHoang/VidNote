                    ...
                    //   if (i == this.state.index){}
                      if (i == this.state.index){
                        return (
                            ...
                            <div ref={i}>
                                <Note _ref={i} note={item} additionalClasses='centerListItem' setCurrVidTime = {this.props.setCurrVidTime } ></Note>
                        ...
                        return (
                            ...
                            <div ref={i}>
                                <Note _ref={i} note={item} additionalClasses='' setCurrVidTime = {this.props.setCurrVidTime }  ></Note>
